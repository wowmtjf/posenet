...
/** An additional thread for running tasks that shouldn't block the UI.   *//*
    ...
    private var foregroundThread: HandlerThread? = null
...
/** Abstract interface to someone holding a display surface.    *//*
    ...
    override fun onCreateView(
            ...
            youtubeView: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? = inflater.inflate(R.layout.tfe_pn_activity_posenet, youtubeView, true)
...
/**
    ...
    private fun startForegroundThread() {
        foregroundThread = HandlerThread("imageAvailableListener").also { it.start() }
        foregroundHandler = Handler(foregroundThread!!.looper)
    }
...
/**
    ...
    private fun stopForegroundThread() {
...
/** Process image using Posenet library.   *//*
    ...
    private fun processImage(bitmap: Bitmap) {
        ...
        draw(canvas, video, scaledBitmap)
    }
